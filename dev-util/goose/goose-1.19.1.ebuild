...
SRC_URI="
        ${CARGO_CRATE_URIS}
        "https://github.com/block/goose/archive/refs/tags/v1.19.1.tar.gz" -> ${P}.tar.gz
"
...
src_prepare() {
        ...
        sed -i \
                "s|git = \"https://github.com/nmathewson/crunchy\", branch = \"cross-compilation-fix\"|path = \"${WORKDIR}/crunchy-260ec5f08969480c342bb3fe47f88870ed5c6cce\"|" \
                "${S}/Cargo.toml" || die
}
