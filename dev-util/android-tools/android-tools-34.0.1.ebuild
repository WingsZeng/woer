...
SRC_URI="https://github.com/nmeum/android-tools/releases/download/${MY_PV}/${PN}-${MY_PV}.tar.xz
	...
	https://raw.githubusercontent.com/nikp123/${PN}/master/patches/adb/0021-Correct-for-XDG-base-directory-on-Linux.patch
"
S="${WORKDIR}/${PN}-${MY_PV}"
...
src_prepare() {
	...
	cd "${S}/vendor/adb" || die
	eapply "${DISTDIR}/0021-Correct-for-XDG-base-directory-on-Linux.patch"
